...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected Bob but got Sue. PersonQueue inserted people at the beginning of the list instead of adding them to the end.
    ...
    // Defect(s) Found: Expected Bob but got Sue. Same problem as above.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Expected Tim but got Sue. GetNextPerson didn't have a way to catch people with infinite turns.
    ...
    // Defect(s) Found: Expected Tim but got Sue. Same problem as above.
